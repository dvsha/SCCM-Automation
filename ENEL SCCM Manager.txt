<#
.SYNOPSIS
    This script is used with System Center Configuration Manager 2012 R2.
...
Param(
    ...
    $CollectionName = "Packaging Team Test Machines",
   
    # Name of device- and user collections used as limiting collections
    $DeviceLimitingCollection = "All Windows Workstations",
...
function Generate-GUI
{
    ...
    $Form1.Text = "ENEL SCCM 2012 Application Manager"
    ...
    $LabelAuthor.Size = New-Object System.Drawing.Size(200, 15)
    $LabelAuthor.Font = New-Object System.Drawing.Font("Microsoft Sans Serif",8.25,0,3,0)
    $LabelAuthor.Text = "Author: Dhirendra Sharma"   
    #~~< PanelPurpose >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    #~~< CheckBoxNonMSIPackage >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    $CheckBoxNonMSIPackage = New-Object System.Windows.Forms.CheckBox
    $CheckBoxNonMSIPackage.Checked = $true
    $CheckBoxNonMSIPackage.CheckState = [System.Windows.Forms.CheckState]::Checked
    $CheckBoxNonMSIPackage.Location = New-Object System.Drawing.Point(278, 370)
    $CheckBoxNonMSIPackage.RightToLeft = [System.Windows.Forms.RightToLeft]::Yes
    $CheckBoxNonMSIPackage.Size = New-Object System.Drawing.Size(123, 24)
    $CheckBoxNonMSIPackage.TabIndex = 20
    $CheckBoxNonMSIPackage.Text = "Non MSI Package"
    $CheckBoxNonMSIPackage.UseVisualStyleBackColor = $true
    $CheckBoxNonMSIPackage.add_CheckedChanged({CheckBoxCreateNonMSIPackage})    
    #~~< ButtonMST >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    #~~< ButtonContent >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    $ButtonContent = New-Object System.Windows.Forms.Button
    $ButtonContent.Location = New-Object System.Drawing.Point(582, 253)
    $ButtonContent.Size = New-Object System.Drawing.Size(75, 23)
    $ButtonContent.TabIndex = 0
    $ButtonContent.Text = "Browse"
    $ButtonContent.UseVisualStyleBackColor = $true
    $ButtonContent.Add_Click({ButtonContent})
    ...
    $LabelSCCMApplicationCreator.Text = "ENEL SCCM 2012 Application Manager"
    ...
    $Form1.Controls.Add($TextBoxNonMSIPackage)
    $Form1.Controls.Add($ButtonContent)
    ...
    $Form1.Controls.Add($CheckBoxNonMSIPackage)
    ...
    $Form1.Controls.Add($LabelNonMSIPackage)
    ...
    $OpenDialogContent = New-Object System.Windows.Forms.FolderBrowserDialog
    $OpenDialogContent.Description = "Select Content Source Location"
    #~~< components >~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Function Load-Form
{
    ...
    $ProgressBar1.Step = 1
    $CheckBoxNonMSIPackage.Enabled = $true
    $CheckBoxNonMSIPackage.Checked = $false
}
...
Function ButtonCreateClick
{
    ...
    If ((Check-ApplicationExist $ApplicationName) -ne $true)
    {
        ...
        {
            Add-CMDeploymentType -ApplicationName $ApplicationName -AutoIdentifyFromInstallationFile -ForceForUnknownPublisher $true -InstallationFileLocation $MSIFile -MsiInstaller -RunInstallationProgramAs32BitProcessOn64BitClient $RunInstallAs32Bit
            Write-Host "Created deployment type based on $MSIFile for $ApplicationName"
            $ProgressBar1.PerformStep()
            ...
            {
                Set-CMDeploymentType -ApplicationName $ApplicationName -DeploymentTypeName $NewDeploymentType.LocalizedDisplayName -InstallationProgram $InstallationProgram -MsiOrScriptInstaller
                Write-Host "Installation program set to: $InstallationProgram"
                $ProgressBar1.PerformStep()
            }
            If ($TextBoxUnInstallProgram.Text.Length -gt 0)
            {
                Set-CMDeploymentType -ApplicationName $ApplicationName -DeploymentTypeName $NewDeploymentType.LocalizedDisplayName -UninstallProgram $UninstallationProgram -MsiOrScriptInstaller
                Write-Host "Uninstallation program set to: $UnInstallationProgram"
                $ProgressBar1.PerformStep()
            }
            If ($TextBoxSourcePath.Text.Length -gt 0)
            {
                Set-CMDeploymentType -ApplicationName $ApplicationName -DeploymentTypeName $NewDeploymentType.LocalizedDisplayName -AllowClientsToShareContentOnSameSubnet $true -AllowClientsToUseFallbackSourceLocationForContent $true -InstallationBehaviorType InstallForSystem -InstallationProgramVisibility Minimized -LogonRequirementType WhereOrNotUserLoggedOn -OnSlowNetworkMode Download -RebootBehavior NoAction -ContentLocation $ContentSourcePath -MsiOrScriptInstaller
                Write-Host "Content source path set to: $ContentSourcePath"
                $ProgressBar1.PerformStep()
            }
            ...
            {
                $cur_date=Get-Date -DisplayHint date
                $cur_time=Get-Date -DisplayHint time
                Start-CMApplicationDeployment -CollectionName $CollectionName -Name $ApplicationName -DeployPurpose $DeployPurpose -AvaliableDate $cur_date -AvaliableTime $cur_time
                Write-Host "Created $DeployPurpose deployment for $ApplicationName to collection $CollectionName"
                $ProgressBar1.PerformStep()
            }
        }

        If ($CheckBoxNonMSIPackage.Checked)
        {
            $InstallationProgram = $TextBoxInstallProgram.Text
            $UninstallationProgram = $TextBoxUnInstallProgram.Text
            $ContentSourcePath = $TextBoxSourcePath.Text
            Add-CMDeploymentType -ApplicationName $ApplicationName -ScriptInstaller -DeploymentTypeName "Non MSI" -InstallationProgram $InstallationProgram -InstallationBehaviorType InstallForSystem -LogonRequirementType WhereOrNotUserLoggedOn -ContentLocation $ContentSourcePath -ManualSpecifyDeploymentType -DetectDeploymentTypeByCustomScript -ScriptType Powershell -ScriptContent "Exit 1" -UninstallProgram $UninstallationProgram
            Write-Host "Created deployment type based on $MSIFile for $ApplicationName"
            $ProgressBar1.PerformStep()
            ...
            Set-CMDeploymentType -ApplicationName $ApplicationName -DeploymentTypeName $NewDeploymentType.LocalizedDisplayName -AllowClientsToShareContentOnSameSubnet $true -AllowClientsToUseFallbackSourceLocationForContent $true -InstallationProgramVisibility Minimized -OnSlowNetworkMode Download -RebootBehavior NoAction -MsiOrScriptInstaller
...
# Function to control actions when clicking on button 'Browse' for Content location
Function ButtonContent
{
    $OpenDialogContent.ShowDialog()
    $TextBoxSourcePath.Text = $OpenDialogContent.SelectedPath
}
